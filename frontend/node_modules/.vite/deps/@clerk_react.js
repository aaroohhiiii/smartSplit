...
import {
  require_jsx_runtime
} from "./chunk-SKH24Q3P.js";
import {
  require_client
} from "./chunk-MWKCYTMA.js";
import {
  require_react_dom
} from "./chunk-UXDD7MME.js";
import {
  require_react
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/clerkRuntimeError-DqAmLuLY.mjs
function createErrorTypeGuard(ErrorClass) {
  function typeGuard(error) {
    ...
    if (ErrorClass.kind && typeof target === "object" && target !== null && "constructor" in target) {
      if (((_a10 = target.constructor) == null ? void 0 : _a10.kind) === ErrorClass.kind) return true;
    }
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/error-qcSj2j-M.mjs
var _a3;
var ClerkAPIError = (_a3 = class {
  constructor(json) {
    ...
    const parsedError = {
      ...
      meta: {
        paramName: (_a10 = json.meta) == null ? void 0 : _a10.param_name,
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/constants-Bta24VLk.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/isomorphicAtob-CoF80qYz.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/keys-DuxzP8MU.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/authorization-errors-CBHAr6Ld.mjs
...
var isReverificationHint = (result) => {
  var _a10, _b;
  return result && typeof result === "object" && "clerk_error" in result && ((_a10 = result.clerk_error) == null ? void 0 : _a10.type) === "forbidden" && ((_b = result.clerk_error) == null ? void 0 : _b.reason) === REVERIFICATION_REASON;
};

// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/authorization-Un7v7f6J.mjs
...
var resolveAuthState = ({ authObject: { sessionId, sessionStatus, userId, actor, orgId, orgRole, orgSlug, signOut, getToken: getToken2, has, sessionClaims }, options: { treatPendingAsSignedOut = true } }) => {
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/deriveState-CQUgOdaO.mjs
...
var deriveFromClientSideState = (state) => {
  ...
  const sessionStatus = (_a10 = state.session) == null ? void 0 : _a10.status;
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/organization-Cy_ag_4B.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/noop-B7RzLU-c.mjs
var noop = (..._args) => {
};

// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/underscore-ClYSgvuy.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/telemetry-DE2JFEBf.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/createDeferredPromise-CYCAgyvC.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/errors-oOcNTWU9.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/react/index.mjs
...
var _provider, _providerCalled, _a5;
var TimeoutManager = (_a5 = class {
  constructor() {
...
}, _provider = new WeakMap(), _providerCalled = new WeakMap(), _a5);
...
var _focused, _cleanup, _setup, _a6;
var FocusManager = (_a6 = class extends Subscribable {
  constructor() {
    super();
...
}, _focused = new WeakMap(), _cleanup = new WeakMap(), _setup = new WeakMap(), _a6);
...
var InfiniteQueryObserver = class extends QueryObserver {
  ...
  createResult(query, options) {
    ...
    const fetchDirection = (_b = (_a10 = state.fetchMeta) == null ? void 0 : _a10.fetchMore) == null ? void 0 : _b.direction;
...
var useClerkQueryClient = () => {
  ...
  return [(queryClient == null ? void 0 : queryClient.client) || mockQueryClient, isLoaded];
};
...
var usePagesOrInfinite = (params) => {
  ...
  const { data, count, page } = (0, import_react.useMemo)(() => {
    ...
    if (triggerInfinite) {
      ...
      const pages = queriesEnabled ? ((_a11 = infiniteQuery.data) == null ? void 0 : _a11.pages) ?? (cachedData == null ? void 0 : cachedData.pages) ?? [] : (cachedData == null ? void 0 : cachedData.pages) ?? [];
    ...
    forceUpdateCounter,
    triggerInfinite,
    (_a10 = infiniteQuery.data) == null ? void 0 : _a10.pages,
  ...
  const fetchPage = (0, import_react.useCallback)((numberOrgFn) => {
    ...
    if (triggerInfinite) {
      ...
      const cachedData = queryClient.getQueryData(infiniteQueryKey);
      if (targetCount - (((_a11 = infiniteQuery.data) == null ? void 0 : _a11.pages) ?? (cachedData == null ? void 0 : cachedData.pages) ?? []).length > 0) infiniteQuery.fetchNextPage({ cancelRefetch: false });
      return;
    }
...
function useSessionBase() {
  ...
  const getInitialState = (0, import_react.useCallback)(() => {
    var _a10;
    return initialState ? (_a10 = deriveFromSsrInitialState(initialState)) == null ? void 0 : _a10.session : void 0;
  }, [initialState]);
  return (0, import_react.useSyncExternalStore)((0, import_react.useCallback)((callback) => clerk.addListener(callback, { skipInitialEmit: true }), [clerk]), (0, import_react.useCallback)(() => {
    if (!clerk.loaded || !clerk.__internal_lastEmittedResources) return getInitialState();
...
function useAttemptToEnableOrganizations(caller) {
  ...
  (0, import_react.useEffect)(() => {
    ...
    (_a10 = clerk.__internal_attemptToEnableEnvironmentSetting) == null ? void 0 : _a10.call(clerk, {
      for: "organizations",
      caller
    });
  }, [clerk, caller]);
...
function useOrganization(params) {
  ...
  const clerk = useClerkInstanceContext();
  (_a10 = clerk.telemetry) == null ? void 0 : _a10.record(eventMethodCalled("useOrganization"));
...
function useOrganizationCreationDefaults(params = {}) {
  ...
  const featureEnabled = ((_c = (_b = (_a10 = clerk.__internal_environment) == null ? void 0 : _a10.organizationSettings) == null ? void 0 : _b.organizationCreationDefaults) == null ? void 0 : _c.enabled) ?? false;
  (_d = clerk.telemetry) == null ? void 0 : _d.record(eventMethodCalled(HOOK_NAME$1));
...
function useOrganizationList(params) {
  ...
  const clerk = useClerkInstanceContext();
  const user = useUserBase();
  (_a10 = clerk.telemetry) == null ? void 0 : _a10.record(eventMethodCalled("useOrganizationList"));
...
var useSession = () => {
  ...
  const session = useSessionBase();
  const clerk = useClerkInstanceContext();
  (_a10 = clerk.telemetry) == null ? void 0 : _a10.record(eventMethodCalled(hookName$2));
...
var useSessionList = () => {
  ...
  (_a10 = useClerkInstanceContext().telemetry) == null ? void 0 : _a10.record(eventMethodCalled(hookName$1));
  if (!client) return {
    isLoaded: false,
    sessions: void 0,
    setActive: void 0
...
function useUser() {
  ...
  const user = useUserBase();
  (_a10 = useClerkInstanceContext().telemetry) == null ? void 0 : _a10.record(eventMethodCalled(hookName));
  ...
  function assertReverification(fetcher) {
    return async (...args) => {
      ...
      if (isReverificationHint(result)) {
        ...
        const isValidMetadata = validateReverificationConfig((_a10 = result.clerk_error.metadata) == null ? void 0 : _a10.reverification);
...
function createBillingPaginatedHook({ hookName: hookName$3, resourceType, useFetcher, options }) {
  return function useBillingHook(params) {
    ...
    const user = useUserBase();
    const organization = useOrganizationBase();
    (_a10 = clerk.telemetry) == null ? void 0 : _a10.record(eventMethodCalled(hookName$3));
...
var useLocalization = () => {
  ...
  let locale = "en";
  try {
    locale = ((_a10 = clerk.__internal_getOption("localization")) == null ? void 0 : _a10.locale) || "en";
  } catch {
  }
...
var PaymentElement = ({ fallback }) => {
  ...
  const applePay = (0, import_react.useMemo)(() => {
    ...
    return { recurringPaymentRequest: {
      ...
      regularBilling: {
        amount: ((_a10 = checkout.totals.totalDueNow) == null ? void 0 : _a10.amount) || checkout.totals.grandTotal.amount,
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/runtimeEnvironment-D1yr0yUs.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/handleValueOrFn-iAIjw-kJ.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/utils-TXJdVJx7.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/getEnvVariable.mjs
var hasCloudflareProxyContext = (context) => {
  var _a10;
  return !!((_a10 = context == null ? void 0 : context.cloudflare) == null ? void 0 : _a10.env);
};
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/object-DYaB_9gA.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/browser-DursrJlr.mjs
function inBrowser() {
...
var useUserButtonCustomMenuItems = (children, options) => {
  ...
  return useCustomMenuItems({
    ...
    allowForAnyChildren: (_a10 = options == null ? void 0 : options.allowForAnyChildren) != null ? _a10 : false
  });
};
...
var waitForElementChildren = createAwaitableMutationObserver({
  ...
  isReady: (el, selector) => {
    var _a10;
    return !!(el == null ? void 0 : el.childElementCount) && ((_a10 = el == null ? void 0 : el.matches) == null ? void 0 : _a10.call(el, selector)) && el.childElementCount > 0;
  }
});
...
var ClerkHostRenderer = class extends import_react13.default.PureComponent {
  ...
  componentDidUpdate(_prevProps) {
    ...
    const customPagesChanged = ((_a10 = prevProps.customPages) == null ? void 0 : _a10.length) !== ((_b = newProps.customPages) == null ? void 0 : _b.length);
...
var CustomPortalsRenderer = (props) => {
  var _a10, _b;
  return import_react4.default.createElement(import_react4.default.Fragment, null, (_a10 = props == null ? void 0 : props.customPagesPortals) == null ? void 0 : _a10.map((portal, index) => (0, import_react4.createElement)(portal, { key: index })), (_b = props == null ? void 0 : props.customMenuItemsPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react4.createElement)(portal, { key: index })));
};
...
var useAuth = (options = {}) => {
  ...
  (_a10 = isomorphicClerk.telemetry) == null ? void 0 : _a10.record(eventMethodCalled("useAuth", { treatPendingAsSignedOut }));
...
function useClerkSignal(signal) {
  ...
  switch (signal) {
    case "signIn":
      (_a10 = clerk.telemetry) == null ? void 0 : _a10.record(eventMethodCalled("useSignIn", { apiVersion: "2025-11" }));
      break;
    case "signUp":
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/deprecated--jK9xTNh.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/versionCheck.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/eventBus-TFTcHo0F.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/clerkEventBus.mjs
var clerkEvents = { Status: "status" };
var createClerkEventBus = () => {
  return createEventBus();
};

// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/retry-DqRIhHV5.mjs
var defaultOptions = {
  initialDelay: 125,
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/loadScript-UG_epen4.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/proxy-BcfViKjn.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/url-C6gPMFx5.mjs
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/versionSelector-DxUAOXiu.mjs
...
var getPrereleaseTag = (packageVersion) => {
  var _a10;
  return (_a10 = packageVersion.trim().replace(/^v/, "").match(/-(.+?)(\.|$)/)) == null ? void 0 : _a10[1];
};
var getMajorVersion = (packageVersion) => packageVersion.trim().replace(/^v/, "").split(".")[0];

// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/loadClerkJsScript.mjs
...
var buildScriptHost = (opts) => {
  ...
  else if (domain && !isDevOrStagingUrl(((_a10 = parsePublishableKey(publishableKey)) == null ? void 0 : _a10.frontendApi) || "")) return addClerkPrefix(domain);
...
var RedirectToSignIn = withClerk(({ clerk, ...props }) => {
  ...
  const hasSignedInSessions = ((_b = (_a10 = client.signedInSessions) == null ? void 0 : _a10.length) != null ? _b : 0) > 0;
...
var _IsomorphicClerk = class _IsomorphicClerk2 {
  constructor(options) {
    ...
    this.buildSignInUrl = (opts) => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildSignInUrl(opts)) || "";
      };
    ...
    this.buildSignUpUrl = (opts) => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildSignUpUrl(opts)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignInUrl = (...args) => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildAfterSignInUrl(...args)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignUpUrl = (...args) => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildAfterSignUpUrl(...args)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterSignOutUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildAfterSignOutUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildNewSubscriptionRedirectUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildNewSubscriptionRedirectUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildAfterMultiSessionSingleSignOutUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildAfterMultiSessionSingleSignOutUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildUserProfileUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildUserProfileUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildCreateOrganizationUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildCreateOrganizationUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildOrganizationProfileUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildOrganizationProfileUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildWaitlistUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildWaitlistUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildTasksUrl = () => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildTasksUrl()) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.buildUrlWithAuth = (to) => {
      const callback = () => {
        var _a10;
        return ((_a10 = this.clerkjs) == null ? void 0 : _a10.buildUrlWithAuth(to)) || "";
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.handleUnauthenticated = async () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.handleUnauthenticated();
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
    ...
    this.on = (...args) => {
      var _a10;
      if ((_a10 = this.clerkjs) == null ? void 0 : _a10.on) {
    ...
    this.off = (...args) => {
      var _a10;
      if ((_a10 = this.clerkjs) == null ? void 0 : _a10.off) {
    ...
    this.replayInterceptedInvocations = (clerkjs) => {
      ...
      (_a10 = __privateGet2(this, _eventBus).internal.retrieveListeners("status")) == null ? void 0 : _a10.forEach((listener) => {
    ...
    this.__experimental_prefetchOrganizationSwitcher = () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.__experimental_prefetchOrganizationSwitcher();
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
      ...
      if (this.clerkjs) {
        ...
        const unsubscribe = () => {
          ...
          if (listenerExtras == null ? void 0 : listenerExtras.handlers) {
            (_b = listenerExtras == null ? void 0 : (_a10 = listenerExtras.handlers).nativeUnsubscribe) == null ? void 0 : _b.call(_a10);
    ...
    this.navigate = (to) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.navigate(to);
      };
      if (this.clerkjs && this.loaded) {
        void callback();
      } else {
    ...
    this.redirectWithAuth = async (...args) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectWithAuth(...args);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToSignIn = async (opts) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToSignIn(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToSignUp = async (opts) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToSignUp(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToUserProfile = async () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToUserProfile();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToAfterSignUp = () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToAfterSignUp();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToAfterSignIn = () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToAfterSignIn();
      };
      if (this.clerkjs && this.loaded) {
        callback();
      } else {
    ...
    this.redirectToAfterSignOut = () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToAfterSignOut();
      };
      if (this.clerkjs && this.loaded) {
        callback();
      } else {
    ...
    this.redirectToOrganizationProfile = async () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToOrganizationProfile();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToCreateOrganization = async () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToCreateOrganization();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToWaitlist = async () => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToWaitlist();
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.redirectToTasks = async (opts) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.redirectToTasks(opts);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.handleRedirectCallback = async (params) => {
      ...
      if (this.clerkjs && this.loaded) {
        void ((_a10 = callback()) == null ? void 0 : _a10.catch(() => {
        }));
      } else {
    ...
    this.handleEmailLinkVerification = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.handleEmailLinkVerification(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithMetamask = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.authenticateWithMetamask(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithCoinbaseWallet = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.authenticateWithCoinbaseWallet(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithBase = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.authenticateWithBase(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithOKXWallet = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.authenticateWithOKXWallet(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithSolana = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.authenticateWithSolana(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.authenticateWithWeb3 = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.authenticateWithWeb3(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.createOrganization = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.createOrganization(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.getOrganization = async (organizationId) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.getOrganization(organizationId);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.joinWaitlist = async (params) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.joinWaitlist(params);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.signOut = async (...args) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.signOut(...args);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
    ...
    this.__internal_attemptToEnableEnvironmentSetting = (options2) => {
      const callback = () => {
        var _a10;
        return (_a10 = this.clerkjs) == null ? void 0 : _a10.__internal_attemptToEnableEnvironmentSetting(options2);
      };
      if (this.clerkjs && this.loaded) {
        return callback();
      } else {
  ...
  get loaded() {
    var _a10;
    return ((_a10 = this.clerkjs) == null ? void 0 : _a10.loaded) || false;
  }
  get status() {
    var _a10;
    if (!this.clerkjs) {
    ...
    return ((_a10 = this.clerkjs) == null ? void 0 : _a10.status) || /**
  ...
  __internal_getOption(key) {
    var _a10, _b;
    return ((_a10 = this.clerkjs) == null ? void 0 : _a10.__internal_getOption) ? (_b = this.clerkjs) == null ? void 0 : _b.__internal_getOption(key) : this.options[key];
  }
  get sdkMetadata() {
    var _a10;
    return ((_a10 = this.clerkjs) == null ? void 0 : _a10.sdkMetadata) || this.options.sdkMetadata || void 0;
  }
  get instanceType() {
    var _a10;
    return (_a10 = this.clerkjs) == null ? void 0 : _a10.instanceType;
  }
  get frontendApi() {
    var _a10;
    return ((_a10 = this.clerkjs) == null ? void 0 : _a10.frontendApi) || "";
  }
  get isStandardBrowser() {
    var _a10;
    return ((_a10 = this.clerkjs) == null ? void 0 : _a10.isStandardBrowser) || this.options.standardBrowser || false;
  }
  get __internal_queryClient() {
    var _a10;
    return (_a10 = this.clerkjs) == null ? void 0 : _a10.__internal_queryClient;
  }
  get isSatellite() {
    if (typeof window !== "undefined" && window.location) {
  ...
  get version() {
    var _a10;
    return (_a10 = this.clerkjs) == null ? void 0 : _a10.version;
  }
  get client() {
    if (this.clerkjs) {
  ...
  get billing() {
    var _a10;
    return (_a10 = this.clerkjs) == null ? void 0 : _a10.billing;
  }
  ...
  get apiKeys() {
    var _a10;
    return (_a10 = this.clerkjs) == null ? void 0 : _a10.apiKeys;
  }
  ...
  get __internal_lastEmittedResources() {
    var _a10;
    return (_a10 = this.clerkjs) == null ? void 0 : _a10.__internal_lastEmittedResources;
  }
};
...
// node_modules/@clerk/react/node_modules/@clerk/shared/dist/runtime/getToken.mjs
var TIMEOUT_MS = 1e4;
...
if (globalThis.__clerkSharedModules) {
  const existingVersion = (_a9 = globalThis.__clerkSharedModules.react) == null ? void 0 : _a9.version;
...
function HandleSSOCallback(props) {
  ...
  (0, import_react31.useEffect)(() => {
    (async () => {
      ...
      if (signIn.status === "needs_first_factor" && !((_a22 = signIn.supportedFirstFactors) == null ? void 0 : _a22.every((f) => f.strategy === "enterprise_sso"))) {
        return navigateToSignIn();
      }
